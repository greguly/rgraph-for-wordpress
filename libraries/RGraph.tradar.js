    ...
    */
    RGraph.Tradar.prototype.Draw = function ()
    {
        ...
        */
        ...
        this.centerx  = this.gutterLeft + ((RGraph.GetWidth(this) - this.gutterLeft - this.gutterRight) / 2);
        this.centery  = this.gutterTop + ((RGraph.GetHeight(this) - this.gutterLeft - this.gutterRight) / 2);
        this.size     = Math.min(RGraph.GetWidth(this) - this.gutterLeft - this.gutterRight, RGraph.GetHeight(this) - this.gutterTop - this.gutterBottom);
